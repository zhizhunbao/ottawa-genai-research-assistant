...
description: Frontend development patterns for React, Next.js, state management, and performance optimization. Use when (1) building React components, (2) implementing state management, (3) optimizing frontend performance, (4) handling forms or animations.
---
...
- Build maintainable React components using composition patterns
...
- [ ] Accessibility attributes present (ARIA, keyboard navigation)
