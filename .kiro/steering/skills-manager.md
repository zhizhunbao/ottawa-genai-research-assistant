...
| scrum, sprint, agile, sprint planning, backlog, user story, standup, retrospective, sprint review, velocity, story points, 敏捷开发, 冲刺, 站会, 用户故事, 待办事项, 回顾会, 故事点, 迭代                                                                                   | `dev-scrum`                 |
