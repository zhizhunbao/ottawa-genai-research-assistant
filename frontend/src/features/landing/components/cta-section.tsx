/**
 * CTASection - Bottom call-to-action banner with gradient background and dual action buttons
 *
 * @module features/landing
 * @source shadcn-landing-page/src/components/Cta.tsx (adapted)
...
export function CTASection({ isAuthenticated }: CTASectionProps) {
  ...
  return (
    <section id="cta" className="py-24 px-6 relative bg-background overflow-hidden">
