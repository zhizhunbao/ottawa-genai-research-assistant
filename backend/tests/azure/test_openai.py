...
from app.azure.openai import AzureOpenAIError, AzureOpenAIService
...
class TestAzureOpenAIService:
    ...
    def mock_clients(self):
        ...
        with patch("app.azure.openai.AzureOpenAI") as mock_sync, \
             patch("app.azure.openai.AsyncAzureOpenAI") as mock_async:
