...
from app.models.user import User, UserPreferences, UserMetadata
...
class UserRepository(BaseRepository[User]):
    ...
    def update_preferences(self, user_id: str, preferences: UserPreferences) -> Optional[User]:
        """Update user preferences."""
        return self.update(user_id, {'preferences': preferences.dict()}) 