...
class SystemRepository:
    ...
    def update_partial_settings(self, updates: Dict[str, Any]) -> SystemSettings:
    ...
    def update_feature_flag(self, feature: str, enabled: bool) -> SystemSettings:
        """Update a specific feature flag."""
        return self.update_partial_settings({
