...
Provides file upload, download, deletion, and temporary SAS URL generation.

@template — Custom Implementation (Azure Blob Storage SDK Wrapper)
@reference azure-search-openai-demo/app/backend/prepdocslib/ (Document ingestion pipeline)
"""
