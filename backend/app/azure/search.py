...
Provides vector search, hybrid search, and semantic ranking capabilities.

@template — Custom Implementation (Azure AI Search SDK Wrapper)
@reference azure-search-openai-demo/app/backend/approaches/ (Hybrid search patterns)
"""
