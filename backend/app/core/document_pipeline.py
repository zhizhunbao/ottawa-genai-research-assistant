...
串联完整的文档处理流程:
Extract (PDF → Text) → Chunk (Text → Chunks)
→ Embed (Chunks → Vectors) → Index (Vectors → Azure AI Search)
"""
...
from app.core.pdf_extractor import ExtractionResult, PdfExtractor, PdfExtractorError
