...
Splits long text into semantic chunks for embedding and indexing in the RAG pipeline.
Strategy: Paragraphs → Sentences → Recursive Character Splitting.

@template H1 backend/doc_intel/document_parser.py — Recursive Text Chunking
@reference ragflow/rag/app/naive.py (Template Chunking: Q&A, Table, Resume, etc.)
@reference sqlite-rag/chunker.py (RecursiveCharacterTextSplitter)
"""
